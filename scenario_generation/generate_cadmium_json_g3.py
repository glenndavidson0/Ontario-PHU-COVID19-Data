...
df = pd.read_csv("../model_data/ontario_phu_clean.csv")  # General information (id, population, area...)
df_adj = pd.read_csv("../model_data/ontario_phu_adjacency.csv")  # Pair of adjacent territories
gdf_ontario = gpd.read_file("../model_data/ontario_phu.gpkg")  # GeoDataFrame with the territories poligons
...
with open("scenario_ontario_phu.json", "w") as f:
